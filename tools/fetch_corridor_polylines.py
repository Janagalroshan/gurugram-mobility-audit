...
Run locally once (after corridors.csv is finalised):
...
Notes:
  * The polylines are for DISPLAY ONLY. Google's live measurements (which
    produce the Congestion Ratio numbers) may follow a different path on
    any given call — the route-invariance of ratio metrics is what
    protects us.
